...
export default function ExecuteTransaction() {
  ...
  return (
    <div className="container mx-auto p-8">
      <h1 className="text-3xl font-bold mb-4">Executar Transação</h1>
      <form onSubmit={handleExecuteTransaction} className="space-y-4">
        ...
        <button type="submit" className="px-4 py-2 text-white bg-blue-600 rounded" disabled={isPending || isConfirming}>
          {isPending ? "Processando..." : isConfirming ? "Aguardando Confirmação..." : "Executar Transação"}
        </button>
      </form>
      {transactionHash && (
        <div className="mt-4">
      ...
      {isConfirmed && <p className="text-green-600 mt-4">Transação executada com sucesso!</p>}
